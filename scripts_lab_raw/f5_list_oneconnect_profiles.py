"""
ABX Action: f5_list_oneconnect_profiles
------------------------------------------
Custom Form data source for the "OneConnect Profile" dropdown (VIP
Configuration section of the requirements doc). Queries the live F5
device for existing oneconnect profiles, plus a "None" option to skip
attaching one. The selected "value" is passed straight through as
"vs.oneconnect_profile".
...
def handler(context, inputs):
    ...
    url = "https://{}/mgmt/tm/ltm/profile/one-connect".format(host)
